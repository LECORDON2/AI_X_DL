...
# Methodology ########################################################################################################################################
# Algorithms은 randomforest를 사용하였습니다. randomforest는 다수의 결정 트리를 학습하는 앙상블 학습 방법의 일종입니다.
...
# 데이터 프레임에서 이후 예측을 위해서 필요 없는 columns를 없애고 Training 데이터와 Target 데이터를 나눕니다.
...
# 결과를 살펴보면 정확도는 0.5470169408298552 입니다.
print(accuracy)
# 0.5470169408298552
...
# VG_Training_int_drop_1_0을 이용해 다시 Training 데이터와 Target 데이터를 나눕니다.
